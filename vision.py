            ...
            if "wake up" in self.query:
                ...
                while True:
                    ...
                    if "go to sleep" in self.query:
                        ...
                        Speak("It good to hear Sir")
                    elif "how are you" in self.query:
                        Speak("An Artificial intelligence is always perfect Sir!")
                    elif "thank you" in self.query:
                        Speak("you are welcome, Sir")
                    elif "do you like sir" in self.query:
                        Speak("who doesn't, a man with a big golden heart, pure soul and amazing personaility")
                    elif "she is sweet" in self.query:
                        Speak("yes she is the sweetest and hardworking")

                    elif "time batao" in self.query:
                       ...
                       from Features import myloc
                       myloc(self.query)
                    elif "where is" in self.query:
                        from Features import googleMap
                    ...
                    elif "aadat chala do" in self.query or "play aadat" in self.query:
                        play_specific_song("E:\\songs\\Atif aslam (AADAT UNPLUGGED).mp3")
                    elif "play tera hone laga hun" in self.query or "tera hone laga hun chala do" in self.query:
                        play_specific_song("E:\\songs\\Tera Hone Laga Hoon Lyrical Video - Ajab Prem Ki Gazab Kahani _ Atif Aslam _ Ranbir, Katrina Kaif.mp3")
                    elif "kahani suno chala do" in self.query or "play kahani suno" in self.query:
                        play_specific_song("E:\\songs\\Kaifi Khalil - Kahani Suno 2.0 [Official Music Video].mp3")
                        ...
                        from open_and_close_apps import openwebapp
                        openwebapp(self.query)
                    elif "close" in self.query:
                        from open_and_close_apps import closeapp
                        closeapp(self.query)

startFunction = MainThread()

class SECRET_Start(QMainWindow):
